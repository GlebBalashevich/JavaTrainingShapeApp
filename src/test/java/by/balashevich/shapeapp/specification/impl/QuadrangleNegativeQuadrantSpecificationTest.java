...
public class QuadrangleNegativeQuadrantSpecificationTest {
    QuadrangleNegativeQuadrantSpecification quadrantSpecification;

    @BeforeTest
    public void setUp() {
        quadrantSpecification = new QuadrangleNegativeQuadrantSpecification();
    }

    @DataProvider(name = "negativeQuadrantSpecificationData")
    public Object[][] createIdSpecificationData() {
        return new Object[][]{
                {new Quadrangle(1, new Point(2, 4), new Point(7, 6),
                        new Point(9, 2), new Point(3, 1)), false},
                {new Quadrangle(3, new Point(-5, -3), new Point(-2, -3),
                        new Point(-1, -7), new Point(-6, -9)), true},
                {new Quadrangle(5, new Point(-2, 2), new Point(3, 4),
                        new Point(5, -4), new Point(-3, 3)), false},
        };
    }

    @Test(dataProvider = "negativeQuadrantSpecificationData")
